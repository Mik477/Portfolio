...
<svelte:head>
  ...
  <meta name="description" content="Configure your Anki card templates for optimal display of HTML tables, LaTeX math, and formatted content from Anki Automation." />
</svelte:head>
...
<div class="guide-container">
  ...
  <iframe
    src="/anki-demo/card-setup.html"
    title="Anki Automation - Card Template Setup Guide"
    class="guide-iframe"
    loading="lazy"
  ></iframe>
</div>
